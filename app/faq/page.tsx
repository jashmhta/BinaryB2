...
export default function FAQPage() {
  ...
  const faqs: FAQItem[] = [
    ...
    {
      category: "Senior Citizens & Succession",
  ...
  return (
    <>
      <Navigation />
      <main className="min-h-screen bg-white dark:bg-black transition-colors duration-300 pt-20">
        <div className="container py-12 md:py-20">
          {/* Header */}
          <div className="text-center mb-12 md:mb-16">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-black text-[hsl(var(--navy))] dark:text-white mb-6">
              Frequently Asked Questions
            </h1>
            <p className="text-xl md:text-2xl text-gray-700 dark:text-gray-300 max-w-3xl mx-auto">
              Everything you need to know about bond investments and our services
            </p>
          </div>
          ...
          {categories.map((category) => (
            <div key={category} className="mb-12">
              <h2 className="text-2xl md:text-3xl font-bold text-[hsl(var(--golden))] mb-6">
                {category}
              </h2>
                ...
                {faqs
                  ...
                  .map((faq, index) => {
                    ...
                    return (
                      <div
                        key={globalIndex}
                        className="bg-gray-50 dark:bg-gray-900 rounded-lg overflow-hidden border border-gray-200 dark:border-gray-800 transition-all duration-300"
                      >
                        <button
                        ...
                        >
                          <span className="text-lg font-bold text-[hsl(var(--navy))] dark:text-white pr-4">
                            {faq.question}
                          </span>
                          {isOpen ? (
                            <ChevronUp className="w-6 h-6 text-[hsl(var(--golden))] flex-shrink-0" />
                          ) : (
                            <ChevronDown className="w-6 h-6 text-[hsl(var(--golden))] flex-shrink-0" />
                          )}
                        </button>
                        {isOpen && (
          ...
          {/* Contact CTA */}
          <div className="mt-16 text-center bg-gradient-to-r from-[hsl(var(--golden-dark))] to-[hsl(var(--golden))] rounded-2xl p-8 md:p-12">
            <h3 className="text-2xl md:text-3xl font-bold text-[hsl(var(--navy))] dark:text-white mb-4">
              Still have questions?
            </h3>
            <p className="text-lg text-[hsl(var(--navy))]/80 dark:text-white/80 mb-6 max-w-2xl mx-auto">
              Our team is here to help. Contact us for personalized assistance with your bond investment needs.
            </p>
            <a
              href="mailto:ENQUIRY@BINARYCAPITAL.IN"
              className="inline-block px-8 py-3 bg-[hsl(var(--navy))] dark:bg-white text-white dark:text-[hsl(var(--navy))] font-semibold rounded-lg hover:opacity-90 transition-opacity"
            >
              Contact Our Experts
            </a>
          </div>
